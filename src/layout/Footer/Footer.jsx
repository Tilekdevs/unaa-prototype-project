  ...
  return (
    <div>
      <footer className="footer">
        ...
        <div className="footer__text">Государственное агентство по регистрации транспортных средств и водительского состава при Кабинете Министров Кыргызской Республики 2024</div>
      </footer>
    </div>
  );
};
